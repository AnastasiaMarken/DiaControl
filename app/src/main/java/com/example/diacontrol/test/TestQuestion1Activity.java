...
public class TestQuestion1Activity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Question q = FindriscTest.getQuestion(1);
		...
		btnContinue.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				Intent intent = new Intent(TestQuestion1Activity.this, TestQuestion2Activity.class);
